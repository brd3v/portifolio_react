  ...
  return (
   ...
   <div>    
    ...
    <div className='projects'>
      <h3>Projetos</h3>
      <div className='row'>
        <div className='col-md-4'><img src="https://raw.githubusercontent.com/brd3v/portifolio_react/main/public/images/termometro.png" alt="" /> <h5>Termometro</h5><p>Projeto Feito com javascript + Reactjs + ajax +  Bootstrap + react icons</p>
